...
#ifndef AI_ESCA_DATASET_MEDIUM_H
#define AI_ESCA_DATASET_MEDIUM_H
#pragma once

#include "esca_dataset_medium_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ESCA_DATASET_MEDIUM_MODEL_NAME          "esca_dataset_medium"
#define AI_ESCA_DATASET_MEDIUM_ORIGIN_MODEL_NAME   "model_medium_b32"

/******************************************************************************/
#define AI_ESCA_DATASET_MEDIUM_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ESCA_DATASET_MEDIUM_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ESCA_DATASET_MEDIUM_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ESCA_DATASET_MEDIUM_IN_NUM        (1)

AI_DEPRECATED
#define AI_ESCA_DATASET_MEDIUM_IN \
  ai_esca_dataset_medium_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ESCA_DATASET_MEDIUM_IN_SIZE { \
  AI_ESCA_DATASET_MEDIUM_IN_1_SIZE, \
}
#define AI_ESCA_DATASET_MEDIUM_IN_SIZE_BYTES { \
  AI_ESCA_DATASET_MEDIUM_IN_1_SIZE_BYTES, \
}
#define AI_ESCA_DATASET_MEDIUM_IN_1_HEIGHT      (320)
#define AI_ESCA_DATASET_MEDIUM_IN_1_WIDTH       (180)
#define AI_ESCA_DATASET_MEDIUM_IN_1_CHANNEL     (3)
#define AI_ESCA_DATASET_MEDIUM_IN_1_SIZE        (320 * 180 * 3)
#define AI_ESCA_DATASET_MEDIUM_IN_1_SIZE_BYTES  (691200)

/******************************************************************************/
#define AI_ESCA_DATASET_MEDIUM_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ESCA_DATASET_MEDIUM_OUT \
  ai_esca_dataset_medium_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ESCA_DATASET_MEDIUM_OUT_SIZE { \
  AI_ESCA_DATASET_MEDIUM_OUT_1_SIZE, \
}
#define AI_ESCA_DATASET_MEDIUM_OUT_SIZE_BYTES { \
  AI_ESCA_DATASET_MEDIUM_OUT_1_SIZE_BYTES, \
}
#define AI_ESCA_DATASET_MEDIUM_OUT_1_CHANNEL     (2)
#define AI_ESCA_DATASET_MEDIUM_OUT_1_SIZE        (2)
#define AI_ESCA_DATASET_MEDIUM_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_ESCA_DATASET_MEDIUM_N_NODES (9)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup esca_dataset_medium
 ...
 * @ref ai_esca_dataset_medium_create. Both the activations memory buffer 
 ...
 * using @ref ai_esca_dataset_medium_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_esca_dataset_medium_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_esca_dataset_medium_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ESCA_DATASET_MEDIUM_*
 * defines into file @ref esca_dataset_medium.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_esca_dataset_medium_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ESCA_DATASET_MEDIUM_H */
