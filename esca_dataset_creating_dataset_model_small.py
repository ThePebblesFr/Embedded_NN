...
np.save(file_xtest, xtest_shuffled.astype(np.float))
np.save(file_ytest, ytest_shuffled.astype(np.float))

file_xtest.close()
file_ytest.close()

print('Time taken for creating dataset of model small {} sec\n'.format(time.time() - start))