...
#                 |-----------------|-----------------------------------|                                                     #
#                 |Description      |This code allows you to increase   |                                                     # 
#                                   |the size of the dataset by making  |                                                     # 
#                                   |any kind of modifications on the   |                                                     #
#                                   |photos of the starting dataset.    |                                                     #
#                 |-----------------|-----------------------------------|                                                     #
...
# This dataset contains the augmented images create by the orginal images, 
# in order to obtain an expanded version of the orginal dataset 
...
# Those are the different transformation that will ocur on the photos
...
new_dataset = 'augmented_esca_dataset2'
...
for class_tag in classes:
  ...
  try:
    if not os.path.exists(output_path):
      ...
      print ("Successfully created the directory %s\n\n" % output_path)   # create the directory path if not existing
